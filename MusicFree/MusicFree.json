...
<head>
  ...
  <link href="/static/errors/stylesheets/dark-for-error.css?t=1761544439137" rel="stylesheet" type="text/css" />
...
<body class="ui_basic application">
      ...
      <div class="ui menu">
        <div class="item gitosc-logo">
          <a href="/">
            ...
            <img class="ui inline image dark-mode-img" src="/static/errors/images/logo.svg?t=1753339916">
          </a>
        </div>
        ...
        <a href="https://moark.com/serverless-api" class="item" title="模力方舟（Gitee AI）" target="_blank">
          <span>模力方舟</span>
          <img src="/static/images/notification-star.svg" alt="模力方舟" style="transform: translate(-5px, -7px)">
        </a>
        <a href="https://gitee.com/ai-teammates" class="item " title="AI 队友" target="_blank">
          <span>AI 队友</span>
        </a>
  ...
  <div class="container error midCenter">
    <div class="content">
      <center>
        <div class="image-box"><img src="/static/errors/images/502.png"></div>
        <h3>欢迎浏览我们的网站，系统可能正在更新中，请稍候片刻。</h3>
        <p><a href="/">点击这里</a>返回首页</p>
      </center>
    </div>
  </div>
  <footer id="git-footer-main" style='margin: 0'>
    ...
    <div id="bottombar-container" class="bottombar-container-placeholder"></div>
  </footer>
  ...
  <script src="/static/errors/javascripts/load_bottombar.js"></script>
